...
android {
    namespace = "com.calleroo.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.calleroo.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "2.0.0-step1"
    ...
    buildTypes {
        debug {
            isDebuggable = true
            // Debug guard enabled
            buildConfigField("boolean", "ENABLE_LOCAL_LOGIC_GUARD", "true")
        }
        release {
            ...
            buildConfigField("boolean", "ENABLE_LOCAL_LOGIC_GUARD", "false")
        }
    }
